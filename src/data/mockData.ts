...
const _deliveryOptions: DeliveryOption[] = [
  {
    id: 'hemleverans-015',
    name: 'Hemleverans med RTC',
    code: '015',
    price: 599,
    priceDisplay: '599 kr',
    deliveryTime: 'Bokbart datum och tid',
    description: 'Leverans med RTC till trottoar- eller tomtgräns inom närområdet. Kunden bokar dag och tid vid beställning.',
    situations: ['Möbler inom 015-området', 'Kunden vill boka exakt datum och tid'],
    notes: ['Trottoar/tomtgräns', 'Bokas dag och tid', 'Postnummer 200 00 – 313 95', 'Dagen innan leverans får kunden ett SMS med ett tresiffrigt intervall', '30 min innan leverans ringer chauffören'],
    ...
    keywords: ['015', 'hemleverans', 'trottoarkant', 'rtc', 'närområde', 'malmö', 'lund', 'halmstad'],
  },
  {
    id: 'bring-012',
    ...
    price: 699,
    priceDisplay: '699 kr',
    deliveryTime: 'Till Bring-terminal, kunden bokar efter SMS',
    description: 'Leverans via Bring. Det datum som visas vid bokning är den dag varan levereras till Bring-terminal. Kunden får sedan ett SMS 2–5 dagar senare för att boka dag och tid för hemleverans.',
    situations: ['Övriga Sverige inom 012-området', 'Bring-täckning'],
    notes: ['Transporteras via Brings terminal', 'Visat datum är leverans till Brings terminal', 'Kunden får SMS 2–5 arbetsdagar efteråt för bokning av dag och tid', 'Postnummer 100 00 – 199 99 och 313 96 – 769 99'],
  ...
  {
    id: 'inbarning-015',
    name: 'Inbärning med RTC',
    code: '010',
    price: 998,
    priceDisplay: '998 kr',
    deliveryTime: 'Bokas tillsammans med 015',
    description: 'Inbärning i bostad med RTC inom närområdet. Bokas tillsammans med 015.',
    situations: ['Möbler som ska bäras in i bostaden', 'Närområde 015'],
    notes: ['Inbärning i bostad', 'Bokas tillsammans med 015', 'Postnummer 200 00 – 313 95', 'Tunga varor (ca 72 kg eller mer) kan ej fås inburna'],
    restrictions: 'Tunga varor (ca 72 kg eller mer) kan ej fås inburna. Kontrollera order och hemsida.',
    coverage: 'Postnummer 200 00 – 313 95',
    cities: ['Malmö', 'Lund', 'Helsingborg', 'Landskrona', 'Eslöv', 'Höör', 'Hörby', 'Ystad', 'Trelleborg', 'Svedala', 'Staffanstorp', 'Vellinge', 'Ängelholm', 'Båstad', 'Halmstad'],
    postalRanges: [[20000, 31395]],
  ...
  {
    id: 'inbarning-012',
    name: 'Inbärning med Bring',
    code: '022',
    price: 1198,
    priceDisplay: '1198 kr',
    deliveryTime: 'Bokas tillsammans med 012',
    description: 'Inbärning i bostad via Bring inom 012-området. Bokas tillsammans med 012.',
    situations: ['Möbler som ska bäras in i bostaden', 'Bring-området 012'],
    notes: ['Inbärning i bostad', 'Bokas tillsammans med 012', 'Postnummer 100 00 – 199 99 och 313 96 – 769 99', 'Tunga varor (ca 72 kg eller mer) kan ej fås inburna'],
    restrictions: 'Tunga varor (ca 72 kg eller mer) kan ej fås inburna. Kontrollera order och hemsida.',
    coverage: 'Postnummer 100 00 – 199 99 och 313 96 – 769 99',
    cities: ['Stockholm', 'Uppsala', 'Västerås', 'Örebro', 'Linköping', 'Norrköping', 'Jönköping', 'Borås', 'Göteborg', 'Trollhättan', 'Uddevalla', 'Karlstad', 'Växjö', 'Kalmar', 'Karlskrona', 'Gävle', 'Sundsvall', 'Falun', 'Luleå', 'Umeå'],
    postalRanges: [[10000, 19999], [31396, 76999]],
  ...
  {
    id: 'bring-013',
    name: 'Bring Hemleverans Fjärr',
    code: '013',
    price: 999,
    priceDisplay: '999 kr',
    deliveryTime: 'Till Bring-terminal, kunden bokar efter SMS',
    description: 'Leverans via Bring för fjärrpostnummer. Det datum som visas vid bokning är den dag varan levereras till Bring-terminal. Kunden får sedan ett SMS 2–5 dagar senare för att boka dag och tid för hemleverans.',
    situations: ['Fjärrkunder inom 013-området', 'Bring-täckning norr'],
    notes: ['Transporteras via Brings terminal', 'Visat datum är leverans till Brings terminal', 'Kunden får SMS 2–5 arbetsdagar efteråt för bokning av dag och tid', 'Postnummer 77 000 – 99 999'],
    coverage: 'Postnummer 77 000 – 99 999',
    cities: ['Luleå', 'Kiruna', 'Piteå', 'Skellefteå', 'Umeå', 'Örnsköldsvik', 'Sundsvall', 'Östersund', 'Gävle', 'Boden', 'Haparanda', 'Kalix', 'Arvidsjaur', 'Lycksele', 'Vilhelmina'],
    postalRanges: [[77000, 99999]],
    keywords: ['013', 'bring', 'hemleverans', 'fjärr', 'norrland'],
  },
  {
    id: 'inbarning-013',
    name: 'Inbärning med Bring Fjärr',
    code: '023',
    price: 1498,
    priceDisplay: '1498 kr',
    deliveryTime: 'Bokas tillsammans med 013',
    description: 'Inbärning i bostad via Bring för fjärrpostnummer. Bokas tillsammans med 013.',
    situations: ['Möbler som ska bäras in i bostaden', 'Bring-området 013'],
    notes: ['Inbärning i bostad', 'Bokas tillsammans med 013', 'Postnummer 77 000 – 99 999', 'Tunga varor (ca 72 kg eller mer) kan ej fås inburna'],
    restrictions: 'Tunga varor (ca 72 kg eller mer) kan ej fås inburna. Kontrollera order och hemsida.',
    coverage: 'Postnummer 77 000 – 99 999',
    cities: ['Luleå', 'Kiruna', 'Piteå', 'Skellefteå', 'Umeå', 'Örnsköldsvik', 'Sundsvall', 'Östersund', 'Gävle', 'Boden', 'Haparanda', 'Kalix', 'Arvidsjaur', 'Lycksele', 'Vilhelmina'],
    postalRanges: [[77000, 99999]],
    keywords: ['023', 'inbärning', 'bring', 'fjärr', 'norrland'],
  },
  {
    id: 'hämtning-030',
...
const _returnProcedures: ReturnProcedure[] = [
  {
    ...
    keywords: ['retur', 'återlämning'],
  },
  {
    id: 'r4',
    title: 'Öppet köp',
    type: 'oppet-kop',
    description: 'Demo-rutin för öppet köp, kunden ångrar sig utan defekt.',
    steps: ['Kontrollera kvitto och tidsfrist', 'Bekräfta att varan är oanvänd och i originalförpackning', 'Registrera öppet köp i kassan', 'Återbetala enligt villkor'],
    keywords: ['öppet köp', 'ångra', 'retur'],
  },
  {
    id: 'r2',
    title: 'Reklamation',
