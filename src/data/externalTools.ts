...
export const externalTools: ExternalTool[] = [
  ...
  },
  {
    ...
    command: '%systemroot%\\system32\\mstsc.exe "C:\\Users\\SEHAL05\\AppData\\Roaming\\Microsoft\\Workspaces\\{A21CD5DE-5AC3-4263-8316-883A546F2187}\\Resource\\AX2012 (ILVA).rdp"',
    icon: Monitor,
  },
]
